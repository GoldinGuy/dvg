...
export function ExecutiveBoard() {
  const boardMembers = [
    ...
    {
      name: "Terrence Ware",
      title: "Founding Member, Vice President of Finance",
    ...
    {
      name: "Sami Moudarres",
      title: "Founding Member, Vice President of Administration",
    ...
    },
    {
      ...
      title: "Founding Member, Vice President of Professional",
    ...
    {
      name: "Alexa Jacob",
      title: "Founding Member, Vice President of Membership",
    ...
    {
      name: "Lauren Hollar",
      title: "Founding Member, Vice President of Recruitment",
    ...
    <section className="py-20 bg-muted/30">
      <div className="container">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-light mb-4 text-primary-800 tracking-wide">Executive Board</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {boardMembers.map((member, index) => (
            <div key={index} className="card-elegant p-6 text-center">
              ...
              <h3 className="text-xl font-normal mb-2 text-primary-800 tracking-wide">{member.name}</h3>
              <p className="text-sm font-light text-primary-600 mb-4 tracking-wide">{member.title}</p>

              <p className="text-sm text-muted-foreground font-light leading-relaxed mb-4 line-clamp-4">{member.bio}</p>

              <Button variant="ghost" size="sm" className="text-primary-600 hover:text-primary-800 font-light">
                Read More
              </Button>
            </div>
          ))}
